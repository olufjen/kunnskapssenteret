        ...
        try {
            ...
            switch (response) {
                ...
                case 206:
                    ...
                    break;
                case 300:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Multiple Choices</td>";
                    ++this.erroneousLinks;
                    break;
                case 301:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Moved Permanently</td>";
                    ++this.erroneousLinks;
                    break;
                case 302:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Found</td>";
                    ++this.erroneousLinks;
                    break;
                case 303:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " See other</td>";
                    ++this.erroneousLinks;
                    break;
                case 304:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Not Modified</td>";
                    ++this.erroneousLinks;
                    break;
                case 305:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Use Proxy</td>";
                    ++this.erroneousLinks;
                    break;
                case 307:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Temporary Redirect</td>";
                    ++this.erroneousLinks;
                    break;
                case 400:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Bad request</td>";
                    ++this.erroneousLinks;
                    break;
                case 401:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Unauthorized</td>";
                    ++this.erroneousLinks;
                    break;
                case 403:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Forbidden</td>";
                    ++this.erroneousLinks;
                    break;
                case 404:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Not Found</td>";
                    ++this.erroneousLinks;
                    break;
                case 405:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Method Not Allowed</td>";
                    ++this.erroneousLinks;
                    break;
                case 406:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Not Acceptable</td>";
                    ++this.erroneousLinks;
                    break;
                case 407:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Proxy Authentication Required</td>";
                    ++this.erroneousLinks;
                    break;
                case 408:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Request Timeout</td>";
                    ++this.erroneousLinks;
                    break;
                case 415:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Unsupported Media Type</td>";
                    ++this.erroneousLinks;
                    break;
                case 500:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Internal Server Error</td>";
                    ++this.erroneousLinks;
                    break;
                case 501:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Not Implemented</td>";
                    ++this.erroneousLinks;
                    break;
                case 502:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Bad Gateway</td>";
                    ++this.erroneousLinks;
                    break;
                case 503:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Service Unavailable</td>";
                    ++this.erroneousLinks;
                    break;
                case 504:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " Gateway Timeout</td>";
                    ++this.erroneousLinks;
                    break;
                case 505:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + response + " HTTP Version Not Supported</td>";
                    ++this.erroneousLinks;
                    break;
                default:
                    response_message = "<td><a href='" + url + "'>" + url + "</a></td>" + "<td>" + " Something unexpected happened</td>";
                    ++this.erroneousLinks;
                    break;
            }
            ++this.linksChecked;
