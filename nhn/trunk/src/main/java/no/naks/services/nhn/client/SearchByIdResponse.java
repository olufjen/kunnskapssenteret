...
public class SearchByIdResponse {
    ...
    @XmlElementRef(name = "SearchByIdResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    ...
    public void setSearchByIdResult(JAXBElement<ArrayOfCommunicationParty> value) {
        this.searchByIdResult = ((JAXBElement<ArrayOfCommunicationParty> ) value);
    }
