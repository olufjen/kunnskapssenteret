...
public class HPRInformation {
    ...
    @XmlElementRef(name = "SpecialCompetences", namespace = "http://register.nhn.no/HPR", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfSpecialCompetence }{@code >}
     *     
     */
    ...
    public void setSpecialCompetences(JAXBElement<ArrayOfSpecialCompetence> value) {
        this.specialCompetences = ((JAXBElement<ArrayOfSpecialCompetence> ) value);
    }
