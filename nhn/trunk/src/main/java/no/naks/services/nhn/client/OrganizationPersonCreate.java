...
/**
 * <p>Java class for OrganizationPersonCreate complex type.
 * 
...
@XmlType(name = "OrganizationPersonCreate", propOrder = {
    "electronicAddresses",
    "hprNumber",
    "parentHerId",
    "physicalAddresses",
...
public class OrganizationPersonCreate {
    ...
    @XmlElementRef(name = "HprNumber", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    ...
    public void setHprNumber(JAXBElement<String> value) {
        this.hprNumber = ((JAXBElement<String> ) value);
    }
