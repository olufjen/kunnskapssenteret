...
public class SearchCertificatesForValidatingSignature {
    ...
    @XmlElementRef(name = "sn", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    protected JAXBElement<String> sn;
    @XmlElementRef(name = "cn", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    protected JAXBElement<String> cn;
    @XmlElementRef(name = "ou", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    ...
    public void setCn(JAXBElement<String> value) {
        this.cn = ((JAXBElement<String> ) value);
    }
    ...
    public void setOu(JAXBElement<String> value) {
        this.ou = ((JAXBElement<String> ) value);
    }
