...
public class SearchCertificatesForValidatingSignatureResponse {
    ...
    @XmlElementRef(name = "SearchCertificatesForValidatingSignatureResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
     ...
     *     
     */
    public JAXBElement<ArrayOfCertificateDetails> getSearchCertificatesForValidatingSignatureResult() {
     ...
     *     
     */
    public void setSearchCertificatesForValidatingSignatureResult(JAXBElement<ArrayOfCertificateDetails> value) {
        this.searchCertificatesForValidatingSignatureResult = ((JAXBElement<ArrayOfCertificateDetails> ) value);
    }
