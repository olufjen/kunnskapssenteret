...
@XmlType(name = "", propOrder = {
    "getCommunicationPartyStatisticsResult"
})
@XmlRootElement(name = "GetCommunicationPartyStatisticsResponse")
public class GetCommunicationPartyStatisticsResponse {

    @XmlElementRef(name = "GetCommunicationPartyStatisticsResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CommunicationPartyStatistics }{@code >}
     *     
     */
     ...
     *     
     */
    public void setGetCommunicationPartyStatisticsResult(JAXBElement<CommunicationPartyStatistics> value) {
        this.getCommunicationPartyStatisticsResult = ((JAXBElement<CommunicationPartyStatistics> ) value);
    }
