...
public class GetCustomAttributesResponse {
    ...
    @XmlElementRef(name = "GetCustomAttributesResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfKeyValuePairOfintArrayOfCodeUO9UWExd }{@code >}
     *     
     */
     ...
     *     
     */
    public void setGetCustomAttributesResult(JAXBElement<ArrayOfKeyValuePairOfintArrayOfCodeUO9UWExd> value) {
        this.getCustomAttributesResult = ((JAXBElement<ArrayOfKeyValuePairOfintArrayOfCodeUO9UWExd> ) value);
    }
