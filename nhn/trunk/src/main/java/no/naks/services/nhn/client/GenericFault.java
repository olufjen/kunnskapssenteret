...
@XmlType(name = "GenericFault", namespace = "http://register.nhn.no/Common", propOrder = {
    "errorCode",
    "message"
})
public class GenericFault {

    @XmlElementRef(name = "ErrorCode", namespace = "http://register.nhn.no/Common", type = JAXBElement.class)
