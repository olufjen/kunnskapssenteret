...
public class UpdateOrganizationDetails {
    ...
    @XmlElementRef(name = "org", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link OrganizationUpdate }{@code >}
     *     
     */
    ...
    public void setOrg(JAXBElement<OrganizationUpdate> value) {
        this.org = ((JAXBElement<OrganizationUpdate> ) value);
    }
