...
public class CreateDepartmentResponse {
    ...
    @XmlElementRef(name = "CreateDepartmentResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    ...
    public void setCreateDepartmentResult(JAXBElement<Department> value) {
        this.createDepartmentResult = ((JAXBElement<Department> ) value);
    }
