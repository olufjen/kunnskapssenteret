...
@XmlType(name = "", propOrder = {
    "getCertificateForEncryptionResult"
})
@XmlRootElement(name = "GetCertificateForEncryptionResponse")
public class GetCertificateForEncryptionResponse {

    @XmlElementRef(name = "GetCertificateForEncryptionResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
    ...
    public void setGetCertificateForEncryptionResult(JAXBElement<byte[]> value) {
        this.getCertificateForEncryptionResult = ((JAXBElement<byte[]> ) value);
    }
