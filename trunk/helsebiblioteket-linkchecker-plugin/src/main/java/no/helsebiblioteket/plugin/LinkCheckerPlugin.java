...
public class LinkCheckerPlugin implements TaskPlugin {
    ...
    private String cmsReceivers;
    private String cmsSender;
    private String cmsSaveFolder;
    ...
    public ArrayList<Category> readConfigFile(){
        ...
        try{
            ...
            this.cmsSender = mailConf.getChild("sender").getText();
            this.cmsSaveFolder = mailConf.getChild("save-folder").getText();
