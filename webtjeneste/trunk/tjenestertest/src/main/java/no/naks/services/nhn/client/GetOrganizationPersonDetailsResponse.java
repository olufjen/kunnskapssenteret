...
@XmlType(name = "", propOrder = {
    "getOrganizationPersonDetailsResult"
})
@XmlRootElement(name = "GetOrganizationPersonDetailsResponse")
public class GetOrganizationPersonDetailsResponse {

    @XmlElementRef(name = "GetOrganizationPersonDetailsResult", namespace = "http://register.nhn.no/CommunicationParty", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link OrganizationPerson }{@code >}
     *     
     */
    ...
    public void setGetOrganizationPersonDetailsResult(JAXBElement<OrganizationPerson> value) {
        this.getOrganizationPersonDetailsResult = ((JAXBElement<OrganizationPerson> ) value);
    }
