	...
	*/
	    ...
	    try {
	       ...
	       // String skjedde = webPagesService.getSpesialSted();
	        String skjedde = hvorHvem.getSpesialSted();
	        cell=getCell(skjedde);
	        table1.addCell(cell);
	     
	        cell=getCell("Sykehus");
	        table1.addCell(cell);
	        String valgtOrganisasjon = hvorHvem.getValgtOrganisasjon();
	        cell=getCell(valgtOrganisasjon);
	        table1.addCell(cell);
	        
	        cell=getCell("Avdeling");
	        table1.addCell(cell);
	        String valgtDepartment = hvorHvem.getValgtDepartment();
	        cell=getCell(valgtDepartment);
	        table1.addCell(cell);
	        
	        cell=getCell("Seksjon, sengepost o.l.");
	        table1.addCell(cell);
	        String seksjon = hvorHvem.getSeksjon();
	        ...
	        if(hvorHvem.getTidForhendelsen() != null){
	        	SimpleDateFormat dateFormat = new SimpleDateFormat("d MMM yyyy");
	        	tidForhendelsen = dateFormat.format(hvorHvem.getTidForhendelsen());
	        }else{
	        	tidForhendelsen="";
	        }
	        ...
	        table2.addCell(cellT2);
	        String dognkode ;
	        if(hvorHvem.getMelding().getDognkode().getDN()!=null){
	        	dognkode= hvorHvem.getMelding().getDognkode().getDN();
	        }else{
	        	dognkode="";
	        }
	        ...
	        table2.addCell(cellT2);
	        String klokkeSlett ;
	        if(hvorHvem.getKlokkeSlett()!=null){
	        	klokkeSlett = hvorHvem.getKlokkeSlett();
	        }else{
	        	klokkeSlett="";
	        }
	        ...
	        String kjonn;
	        String strKjonnId = hvorHvem.getKjonnKode();
			if(!strKjonnId.equals("")){
	        ...
	        table3.addCell(cellT3);
	        String aarFodt;
	        Integer aar = new Integer(hvorHvem.getMelding().getArfodt());
			...
			*/
	        ...
	        String Saksnummer;
	        if(hvorHvem.getCaseNr() != null){
	        	Saksnummer =  hvorHvem.getCaseNr();
	        }else{
	        	Saksnummer="";
	        }
	        cellT4=getCell(Saksnummer);
	        ...
	        String beskriv;
	        if(hendelse.getOrgHendelse() != null){
	        	beskriv =  hendelse.getOrgHendelse() ;
	        }else{
	        	beskriv="";
	        }
	        ...
	        table5.addCell(cellT5);
	        String konsekvenser;
	        if(hendelse.getMelding().getKonsekvenser() != null){
	        	konsekvenser =  hendelse.getMelding().getKonsekvenser() ;
	        }else{
	        	konsekvenser="";
	        }
	        ...
	        table5.addCell(cellT5);
	        String alvorlighet;
	        if(hendelse.getMelding().getAlvorlighetsgrad().getDN() != null){
	        	alvorlighet =  hendelse.getMelding().getAlvorlighetsgrad().getDN();
	        }else{
	        	alvorlighet="";
	        }
	        cellT5=getCell(alvorlighet);
	        ...
	        table5.addCell(cellT5);
	        String skaden;
	        if(hendelse.getMelding().getUtfortestrakstiltak() != null){
	        	skaden =  hendelse.getMelding().getUtfortestrakstiltak();
	        }else{
	        	skaden="";
	        }
	        ...
	        table5.addCell(cellT5);
	        String oppdaget;
	        if(hendelse.getMelding().getHvordanoppdaget() != null){
	        	oppdaget =  hendelse.getMelding().getHvordanoppdaget();
	        }else{
	        	oppdaget="";
	        }
	        ...
	        String jegEr;
	        if(kontaktInfo.getMelding() != null){
	        	jegEr =  kontaktInfo.getMelding().getRolle() ;
	        }else{
	        	jegEr="";
	        }
	        ...
	        table7.addCell(cellT7);
	        String navn;
	        if(kontaktInfo.getPerson() != null){
	        	navn =  kontaktInfo.getPerson().getNavn() ;
	        }else{
	        	navn="";
	        }
	        cellT7=getCell(navn);
	        ...
	        String epost;
	        if(kontaktInfo.getPerson() != null){
	        	epost =  kontaktInfo.getPerson().getEPost() ;
	        }else{
	        	epost="";
	        }
	        ...
	        if(kontaktInfo.getPerson() != null){
	        	telefonnummer =  kontaktInfo.getPerson().getTelefonNummer() ;
	        }else{
	        	telefonnummer="";
	        }
	        cellT7=getCell(telefonnummer);
	        ...
	        table7.addCell(cellT7);
	        String lederNavn;
	        if(kontaktInfo.getLeder() != null){
	        	lederNavn =  kontaktInfo.getLeder().getNavn() ;
	        }else{
	        	lederNavn="";
	        }
	        ...
	        String lederEpost;
	        if(kontaktInfo.getLeder() != null){
	        	lederEpost =  kontaktInfo.getLeder().getEPost() ;
	        }else{
	        	lederEpost="";
	        }
	        ...
	        String lederTel;
	        if(kontaktInfo.getLeder() != null){
	        	lederTel =  kontaktInfo.getLeder().getTelefonNummer() ;
	        }else{
	        	lederTel="";
	        }
	        ...
	        table7.addCell(cellT7);
	        String onsker;
	        boolean blOnskerhjelp = kontaktInfo.getMelding().isOnskerhjelp();
			if(blOnskerhjelp){
				onsker = "Ja";
			}else{
				onsker = "Nei";
